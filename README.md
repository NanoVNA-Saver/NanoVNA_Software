...
Supports the orginal NanoVNA, the V2+ and V2+4 (Note there is a seperate branch for each VNA. If you are installing the first time, use the the main release.  This is a spanned ZIP file.  I use 7-ZIP.)
